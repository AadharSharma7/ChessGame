...
class Rook(Piece):
    ...
    def check_for_blocks(self, pieces):
        num1 = 1
        num2 = 1
        num3 = 1
        num4 = 1
    ...
    def check_blocks(self):
        if self.color == black:
            self.check_for_blocks(all_pieces)
    ...
    def move_child(self, new_x, new_y, circle_list):
        for i in range(len(circle_list)):
    ...
    def move(self, new_x, new_y):
        if self.click:
            self.move_child(new_x, new_y, self.circles_posX)
            self.move_child(new_x, new_y, self.circles_negX)
            self.move_child(new_x, new_y, self.circles_posY)
            self.move_child(new_x, new_y, self.circles_negY)
        # self.click = False
...
class Bishop(Piece):
    ...
    def move(self, new_x, new_y):
        if self.click:
            self.move_child(new_x, new_y, self.circles_northeast)
            self.move_child(new_x, new_y, self.circles_northwest)
            self.move_child(new_x, new_y, self.circles_southeast)
            self.move_child(new_x, new_y, self.circles_southwest)
        # self.click = False
...
class King(Piece):
    ...
    def make_circle(self, circle, x, y, block):
        if not block:
            circle.x = self.x + x
            circle.y = self.y + y
            circle.rect.center = (circle.x, circle.y)
    ...
    def possible_moves(self):
        ...
        if self.color == white:
            self.check_blocks(white_pieces)
        self.make_circle(self.circle_px, 80, 0, self.block_px)
        self.make_circle(self.circle_nx, -80, 0, self.block_nx)
        self.make_circle(self.circle_py, 0, 80, self.block_py)
        self.make_circle(self.circle_ny, 0, -80, self.block_ny)
        self.make_circle(self.circle_ne, 80, -80, self.block_ne)
        self.make_circle(self.circle_se, 80, 80, self.block_se)
        self.make_circle(self.circle_sw, -80, 80, self.block_sw)
        self.make_circle(self.circle_nw, -80, -80, self.block_nw)

    def move_child(self, new_x, new_y, circle):
        if new_x in range(circle.x - 35, circle.x + 35) and new_y in range(circle.y - 35, circle.y + 35):
            self.rect.center = circle.rect.center
            self.x = circle.x
            self.y = circle.y
    ...
    def move(self, new_x, new_y):
        if self.click:
            self.move_child(new_x, new_y, self.circle_px)
            self.move_child(new_x, new_y, self.circle_nx)
            self.move_child(new_x, new_y, self.circle_py)
            self.move_child(new_x, new_y, self.circle_ny)
            self.move_child(new_x, new_y, self.circle_ne)
            self.move_child(new_x, new_y, self.circle_se)
            self.move_child(new_x, new_y, self.circle_sw)
            self.move_child(new_x, new_y, self.circle_nw)
        # self.click = False
        self.kill_circles()
        self.reset_blocks()
