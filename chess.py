...
class Piece(pygame.sprite.Sprite):
    ...
    def find_board_position(self):
        for i in range(8):
            for j in range(8):
                if self.x in range(chess_board[i][j].x, chess_board[i][j].x + 80) and \
                        self.y in range(chess_board[i][j].y, chess_board[i][j].y + 80):
                    print("self.x, self.y = " + str(p.x) + ", " + str(p.y))
                    print("chess_board[" + str(i) + "]" + "[" + str(j) + "]" + ".x" + " = " +
                          str(chess_board[i][j].x) + " < " + str(p.x) + " < " + str(chess_board[i][j].x + 80))
                    print("chess_board[" + str(i) + "]" + "[" + str(j) + "]" + ".y" + " = " +
                          str(chess_board[i][j].y) + " < " + str(p.y) + " < " + str(chess_board[i][j].y + 80))
                    self.board_x = j
                    self.board_y = i
